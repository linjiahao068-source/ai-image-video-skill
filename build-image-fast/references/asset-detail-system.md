...
??????????? `asset-plan-v0.x` ???????`required / optional / skipped`????????????????????????? G0 ????????simple/direct ????? `minimal` ? `none` ??????????? optional ??????? hard fidelity/rights/layout ????? required ??

`character_profile`?`relationship_map`?`world_setting` ?????????????/????? annotated ??/QA ????? clean group????????????? clean group?G0 ?????????G1 ????????????
