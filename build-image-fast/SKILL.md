...
???????????? V5 ????????????? 0/1/2 ????`direct=0`?`guided=G0`?`controlled=G0+G1`?G2 ? QA ????????????????????????????????

### ???????

??????????????? `production_profile`???????????????????????

- `fast`?????????????????????? `gpt-5.6-luna + low`?`generation_route=fast`?????????????
- `balanced`??????? `gpt-5.6-terra + medium`????? `fast` ? `stable` ???
- `quality`???????/???????????????????? `gpt-5.6-sol + high`?`generation_route=stable` ????????

????? Codex ????????????????????????????????? `active_agent_model` ? `active_reasoning_effort`????????????????????????? Fast ?????????????????????????????????

### ??????????

?????????? `asset-plan-v0.x` ???????????????????????? `required / optional / skipped`??????????????????/????????`guided/controlled` ??????????? G0?????? optional ??hard-risk ? required ??????`direct` ????????????????? `minimal` ? `none`???????????

?? G0 ???? selected/required ???????????????????????/??????????????????????????????????/QA ????????????? clean group??????????????????????????? `controlled`???????? G1?????????

???? canon????????/???????????????????? 1?3 ??????? `reference-map` ?? URL???????????????????????????? URL ???????????????? unknown????????

### ????????

???????????? [??????](assets/generation-request-template.json)??? `generation-request-v0.x.json` ? `role_deliverable:generation_request`???????????????????????avoid????clean reference ??/??/SHA-256??? visual-bible?asset-plan?prompt-pack ????????????????`generation-log` ????????????????????????????????????

### G2 ??????????

G2 ?? QA ???????? `delivered_pending_acceptance`?????????`???????????` ??????????????????????????????????????????????????????????

?????????? G2 ? `user_confirmed` ??????? `scripts/package_handoff.py`??????? `completed`?????????????????????????/??????? release ?????????????Build Pack ? `handoff-manifest.json`??????SHA-256???????????????????????/?????????? ZIP ??? `handoff_archive`??????????? Build Pack?
